...
/bin/cc -Wall -Wextra -Werror -g3 "$src_dir/ft_print_memory.c" "$script_dir/main.c" -o "$executable"
...
if [[ $? -ne 0 ]]; then
	...
	diff -au --color=always <(cut -c17- "$script_dir/user_output") <(cut -c17- "$script_dir/expected_output")
