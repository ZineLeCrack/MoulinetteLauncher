...
else if [[ "$dir" == "C02" ]]; then

	script_dir="$(dirname "${BASH_SOURCE[0]}")"
	bash "$script_dir/C02/C02.sh"
...
else if [[ "$dir" == "C03" ]]; then

	script_dir="$(dirname "${BASH_SOURCE[0]}")"
	bash "$script_dir/C03/C03.sh"
...
else if [[ "$dir" == "C04" ]]; then

	script_dir="$(dirname "${BASH_SOURCE[0]}")"
	bash "$script_dir/C04/C04.sh"
...
else if [[ "$dir" == "C05" ]]; then

	script_dir="$(dirname "${BASH_SOURCE[0]}")"
	bash "$script_dir/C05/C05.sh"
...
else if [[ "$dir" == "C06" ]]; then

	script_dir="$(dirname "${BASH_SOURCE[0]}")"
	bash "$script_dir/C06/C06.sh"
...
else if [[ "$dir" == "C07" ]]; then

	script_dir="$(dirname "${BASH_SOURCE[0]}")"
	bash "$script_dir/C07/C07.sh"
...
else if [[ "$dir" == "C10" ]]; then

	script_dir="$(dirname "${BASH_SOURCE[0]}")"
	bash "$script_dir/C10/C10.sh"
...
else if [[ "$dir" == "C11" ]]; then

	script_dir="$(dirname "${BASH_SOURCE[0]}")"
	bash "$script_dir/C11/C11.sh"
...
else if [[ "$dir" == "C12" ]]; then

	script_dir="$(dirname "${BASH_SOURCE[0]}")"
	bash "$script_dir/C12/C12.sh"
...
else if [[ "$dir" == "C13" ]]; then

	script_dir="$(dirname "${BASH_SOURCE[0]}")"
	bash "$script_dir/C13/C13.sh"
