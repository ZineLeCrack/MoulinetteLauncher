...
if [[ $? -ne 0 ]]; then
	...
	echo -n "stdin  : " > "$script_dir/user_stdin_output"
	echo -n "stderr : " > "$script_dir/user_stderr_output"
	"$executable" -C "$script_dir/error.txt" "$script_dir/test.txt" "$script_dir/test.txt" >> "$script_dir/user_stdin_output" 2>> "$script_dir/user_stderr_output"
	cat "$script_dir/user_stdin_output" "$script_dir/user_stderr_output" >> "$script_dir/user_output"
	echo "Exit status:" $? >> "$script_dir/user_output"
	...
	echo -n "stdin  : " > "$script_dir/user_stdin_output"
	echo -n "stderr : " > "$script_dir/user_stderr_output"
	"$executable" -C "$script_dir/test.txt" "$script_dir/no_perm.txt" >> "$script_dir/user_stdin_output" 2>> "$script_dir/user_stderr_output"
	cat "$script_dir/user_stdin_output" "$script_dir/user_stderr_output" >> "$script_dir/user_output"
	echo "Exit status:" $? >> "$script_dir/user_output"
	...
	echo -n "stdin  : " > "$script_dir/user_stdin_output"
	echo -n "stderr : " > "$script_dir/user_stderr_output"
	"$executable" -C "$script_dir/test.txt" "$script_dir/test.txt" "$script_dir/test.txt" "$script_dir/test.txt" "$script_dir/test.txt" >> "$script_dir/user_stdin_output" 2>> "$script_dir/user_stderr_output"
	cat "$script_dir/user_stdin_output" "$script_dir/user_stderr_output" >> "$script_dir/user_output"
	echo "Exit status:" $? >> "$script_dir/user_output"
